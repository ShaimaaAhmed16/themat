...
<head>
    ...
    <style>
        .bg {
            background-image: url('{{asset('public/front/images/splash.jpeg')}}');
...
<script src="{{asset('public/front/https://unpkg.com/sweetalert/dist/sweetalert.min.js')}}"></script>
<script src="{{asset('public/front/js/main.js')}}"></script>
<script>

    setTimeout(function()
    {window.location.href='{{route('home')}}'}, 3000);
</script>
</body>
</html>